...
full arc outline is in `work/outline/`." Avoid passing everything
preemptively.
...
`vocab.md` file or write the decision down before handing off. This matters
most for magic systems, factions, recurring in-world phrases, titles,
relationship labels, and terms the author corrected during conversation.
