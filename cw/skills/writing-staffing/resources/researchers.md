...
Fast, cheap local content reading. Navigates the project's files and knowledge graph to gather context before more expensive agents run. Also mines past sessions for historical context by reading Claude Code session transcripts.
