...
The outliner does not brainstorm. For wide-open exploration and option generation before a direction is chosen, spawn the brainstormer agent using the Agent tool instead. Outlining starts after the author has committed to a direction; brainstorming is how they get there.
