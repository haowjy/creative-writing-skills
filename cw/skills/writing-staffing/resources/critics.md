...
```
Spawn a critic agent using the Agent tool with focus: structure, passing the draft file
Spawn a critic agent using the Agent tool with focus: continuity, passing the draft and canon files
Spawn a critic agent using the Agent tool with focus: voice, passing the draft and voice style files
```
