...
model-policies:
  ...
  - match:
      alias: gpt
    override: {}
skills: [agent-management, meridian-spawn, meridian-work-coordination, writing-staffing, story-context, writing-artifacts, decision-log, kb-conventions, md-validation, handoff]
tools:
