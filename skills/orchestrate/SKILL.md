...
name: orchestrate
description: >
  Shared coordination model for writing orchestrators — delegation discipline,
  convergence loops, critique synthesis, and artifact persistence. Load when
  you coordinate work across multiple spawns rather than producing content
  directly.
---
...
Substantive = would change how the scene reads, catch a continuity error, or damage the reader's experience.
Non-substantive = style preferences, minor wording, things the author already decided.
